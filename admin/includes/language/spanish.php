...
$LANG = array (
    ...
    'ga_enter_credentials' => 'Debe introducir los crendenciales de usuario',
    ...
    'use_md5_password_as_salt' => 'Usar el password como SALTkey',
    ...
    'lastname' => 'Apellidos',
    'user_login' => 'Login',
    'at_user_new_lastname' => 'El apellido del usuario #user_login# ha cambiado',
    'at_user_new_name' => 'El nombre del usuario #user_login# ha cambiado',
    ...
    'at_user_pwd_changed' => 'Clave del usuario #user_login# cambiada',
    'at_user_initial_pwd_changed' => 'Clave inicial del usuario #user_login# cambiada',
    'user_mngt' => 'Gestión de usuarios',
    'select' => 'elegir',
    'user_activity' => 'Actividad del usuario',
    'items' => 'Elementos',
    'enable_personal_saltkey_cookie' => 'Habilitar el almacenar la clave Salt personal en una cookie',
    'personal_saltkey_cookie_duration' => 'Tiempo de vida en DIAS de la clave Salt personal antes de que expire',
    'admin_emails' => 'Emails',
    ...
    'email_body_item_updated' => 'Hola:<br><br>La clave para \'#item_label#\' ha sido actualizada.<br /><br />Puede comprobarla <a href=\'".@$_SESSION[\'settings\'][\'cpassman_url\']."/index.php?page=items&group=#item_category#&id=#item_id#\'>AQUÍ</a><br /><br />Saludos',
    ...
    'migrate_pf_user_salt' => 'Introduce la contraseña "SALT" para el Usuario seleccionado',
    'migrate_pf_no_sk' => 'No has introducido tu clave SALT',
    ...
    'personal_saltkey_lost' => 'La he perdido',
    ...
    'admin_action_change_salt_key' => 'Cambiar la clave SALT principal',
    'admin_action_change_salt_key_tip' => 'Antes de cambiar la clave SALT, asegúrese de realizar un backup completo de la base de datos y ponga la herramienta en Mantenimiento para evitar que ningún usuario se pueda conectar.',
    ...
    'pw_encryption_error' => '¡Error en encriptación de la contraseña!',
    'enable_send_email_on_user_login' => 'Enviar un correo a los administradores cuando un usuario se conecte',
    'email_subject_on_user_login' => '[TeamPass] Un usuario se ha conectado',
    ...
    'email_body1' => 'Hol',
    'email_body2' => 'ha sido creado.&lt;br /&gt;&lt;br /&gt;Puede verlo haciendo click en &lt;a href=\'',
    'email_body3' => '\'&gt;este enlace&lt;/a&gt;&lt;br /&gt;&lt;br /&gt;Saludos.',
    ...
    'error_salt' => '&lt;b&gt;La clave SALT es demasiado larga. No utilice la herramienta hasta que un Administrador modifique su clave Salt.&lt;/b&gt; En el archivo settings.php la clave Salt no puede ser superior a 32 caracteres.',
    ...
    'home_personal_saltkey_button' => 'Guardar',
    'home_personal_saltkey_info' => 'Debería ingresar su clave Salt personal si necesita usar sus elementos personales.',
    'home_personal_saltkey_label' => 'Ingrese su clave Salt personal',
    ...
    'import_csv_dialog_info' => 'Información: La importación debe hacerse usando un archivo CSV. Generalmente un archivo exportado desde KeePass tiene la estructura esperad',
    ...
    'menu_title_new_personal_saltkey' => 'Cambiando su clave Salt personal',
    'minutes' => 'minutos',
    ...
    'new_saltkey_warning' => 'Por favor, asegúrese de utilizar la clave Salt original. De no ser así, la nueva encriptación se corromperá. ¡Antes de realizar ningún cambio, compruebe su clave Salt actual!',
    ...
    'personal_saltkey_change_button' => 'Cámbialo',
    'personal_salt_key' => 'Su clave Salt personal',
    'personal_salt_key_empty' => 'No se ha introducido clave Salt personal',
    'personal_salt_key_info' => 'Esta clave Salt se usará para encriptar y desencriptar sus contraseña',
    ...
    'settings_maintenance_mode' => 'Poner TeamPass en Modo Mantenimiento',
    'settings_maintenance_mode_tip' => 'Este modo negará el acceso a cualquier usuario con excepción de los Administradores.',
    ...
    'old_saltkey' => 'SALT key antigua',
    'define_old_saltkey' => 'Quiero espeficicar la clave de SALT antigua para usar (opcional)',
    ...
    'groups' => 'Carpetas',
    'duplicate' => 'Duplicado',
    'duplicate_title_in_same_folder' => '!Ya existe un elemento con el mismo nombre en la carpeta actual! ¡No se permiten nombres duplicados!',
    ...
    'pf_sk_set' => 'Su clave "Salt" personal se ha establecido correctamente, puede pulsar sobre el botón Empezar',
