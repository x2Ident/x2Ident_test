...
$LANG = array (
    ...
    'items_changed' => 'е променен.',
    'ga_not_yet_synchronized' => 'Get identified with Google Authenticator',
    'ga_scan_url' => 'Моля сканирайте този флашкод със вашето мобилно Google Authenticator приложение. ',
    ...
    'settings_get_tp_info' => 'Автоматично зареждане на информация относно Teampass',
    ...
    'category_in_folders' => 'Редактиране на папки от тази категория',
    'select_folders_for_category' => 'Select the Folders to associate to this Category of Fields',
    'offline_mode_warning' => 'Off-line режима позволява да свалите във HTML формат вашите записи, за да може да ги достъпвате когато не сте свързани със Teampass сървъра. Паролите са кодирани със вашият ключ.',
    ...
    'administrators_only' => 'Само администратори',
    'managers_of' => 'Managers of role',
    'managed_by' => 'Managed by',
    'admin_small' => 'Администратор',
