...
$LANG = array (
    ...
    'items_changed' => 'đã được thay đổi',
    'ga_not_yet_synchronized' => 'Lấy thông tin xác thực với Google Authenticator',
    'ga_scan_url' => 'Hãy sử dụng Google Authenticator trên điện thoại di động để quét mã vạch này. Sau đó lấy mã xác thực do phần mềm sinh ra.',
    ...
    'at_field' => 'Trường',
    'category_in_folders_title' => 'Thư mục liên quan',
    'category_in_folders' => 'Sửa Thư mục trong chuyên mục này',
    'select_folders_for_category' => 'Select the Folders to associate to this Category of Fields',
    'offline_mode_warning' => 'Chế độ ngoại tuyến cho phép kết xuất thông tin dạng tài liệu HTML, vì thế bạn có thể truy suất các dữ liệu này khi không kết nối đến máy chủ Teampass. Mật khẩu sẽ được mã hóa sử dụng Bộ khoá mà bạn đã cung cấp.',
    'offline_menu_title' => 'Chế độ ngoại tuyến',
    ...
    'categories' => 'Các mục',
    'new_category_label' => 'Tạo thêm mục mới - Nhập tiêu đề',
    'no_category_defined' => 'Chưa định nghĩa mục nào',
    'confirm_deletion' => 'Bạ có chắc chắn muốn xoá? ',
    'confirm_rename' => 'Xác nhận đổi tên? ',
    'new_field_title' => 'Nhập tiêu đề cho Trường dữ liệu mới',
    'confirm_creation' => 'Xác nhận tạo?',
    'confirm_moveto' => 'Xác nhận di chuyển trường? ',
    'for_selected_items' => 'Với các đối tượng đã chọn ',
    'move' => 'Di chuyển tới',
    'field_add_in_category' => 'Thêm trường mới cho mục này',
    'rename' => 'Đổi tên',
    ...
    'html' => 'html',
    'more' => 'Thêm ',
    'save_categories_position' => 'Lưu thứ tự sắp xếp',
    'reload_table' => 'Tải lại bảng',
    ...
    'settings_encryptClientServer' => 'Quá trình trao đổi thông tin đã được mã hóa',
    ...
    'channel_encryption_no_iconv' => 'Không thể kích hoạt việc mã hóa do ',
    ...
    'is_administrated_by_role' => 'Tài khoản được quản lý bởi',
    ...
    'channel_encryption_no_file' => 'Không tìm thấy bộ khóa để mã hóa!<br>Vui lòng chạy tiến trình nâng cấp.',
    'admin_action_generate_encrypt_keys' => 'Tạo bộ khóa phục vụ mã hóa',
    'admin_action_generate_encrypt_keys_tip' => 'Bộ khóa mã hóa là thành phần rất quan trọng để bảo mật toàn bộ quá trình cài đặt Teampass. Bộ khóa này được sử dụng để mã hóa việc trao đổi dữ liệu giữa máy chủ và máy trạm của người sử dụng. Ngay cả khi bộ khóa này được bảo vệ tránh truy cập qua giao thức WWW thì bạn vẫn nên tạo bộ khóa phục vụ mã hóa mỗi lần cài đặt. Việc tạo bộ khóa sẽ mất khoảng 1 phút để hoàn thành.',
    'settings_anyone_can_modify_bydefault' => 'Activate \'<b><i>Anyone can modify</b></i>\' option by default',
    'channel_encryption_in_progress' => 'Đang mã hóa kênh truyền...',
    'channel_encryption_failed' => 'Xác thực không thành công!',
    'purge_log' => 'Xóa lịch sử từ ngày',
    'to' => 'đến',
    'purge_now' => 'Xóa ngay!',
    'purge_done' => 'Đã xóa! Số lượng bản ghi bị xóa: ',
    ...
    'at_user_new_name' => 'Tài khoản #user_login# thay đổi tên truy cập',
    'info_list_of_connected_users_approximation' => 'Lưu ý: Danh sách có thể nhiều hơn danh sách người dùng trực tuyến hiện tại.',
    'disconnect_all_users' => 'Ngắt kết nối của mọi người dùng (trừ Quản trị viên)',
    'role' => 'Nhóm quyền',
    ...
    '2factors_tile' => 'Xác thực 2 lớp',
    '2factors_image_text' => 'Vui lòng quét mã vạch',
    '2factors_confirm_text' => 'Nhập mã xác thưc một lần',
    'bad_onetime_password' => 'Mã xác thực không chính xác',
    'error_string_not_utf8' => 'Lỗi phát sinh do chuỗi vừa nhập không phải UTF8!',
    ...
    'error_mcrypt_not_loaded' => 'Thư viện \'mcrypt\' chưa được kích hoạt trong thông số PHP trên máy chủ. TeamPass cần thư viện này để thực hiện việc mã hóa. Hãy yêu cầu hỗ trợ từ quản trị viên hệ thống.',
    'at_user_added' => 'Tài khoản #user_login# tạo thành công',
    'at_user_deleted' => 'Tài khoản #user_login# bị xóa',
    'at_user_locked' => 'Tài khoản #user_login# đã bị khóa',
    'at_user_unlocked' => 'Tài khoản #user_login# đã mở khóa',
    'at_user_email_changed' => 'Tài khoản #user_login# đã thay đổi email',
    'at_user_pwd_changed' => 'Tài khoản #user_login# thay đổi mật khẩu',
    'at_user_initial_pwd_changed' => 'Mật khẩu khởi tạo của #user_login# đã thay đổi',
    'user_mngt' => 'Quản lý người dùng',
    'select' => 'lựa chọn',
    ...
    'admin_emails' => 'Emails',
    'admin_emails_configuration' => 'Cấu hình Email',
    'admin_emails_configuration_testing' => 'Kiểm tra cấu hình',
    ...
    'admin_email_test_configuration' => 'Kiểm tra cấu hình Email',
    ...
    'admin_email_result_nok' => 'Không thể gửi Email... hay kiểm tra lại thông tin cấu hình. Tham khảo thông tin lỗi sau: ',
    ...
    'admin_email_send_backlog' => 'Gửi email tồn đọng (còn tồn #nb_emails# emails)',
    ...
    'pdf_export' => 'Kết xuất ra PDF',
    'pdf_password' => 'Mã hóa PDF',
