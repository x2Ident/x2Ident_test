...
$LANG = array (
    ...
    'email_ga_subject' => 'Twój Google Authenticator flash code dla Teampass',
    'email_ga_text' => 'Witaj,<br><br>Proszę, kliknij <a href=\'#link#\'>LINK</a> i użyj aplikacji Google Authenticator by otrzymać Twoje dane logowania OTP dla Teampass.<br /><br />Cheers',
    ...
    'ga_scan_url' => 'Proszę zeskanuj ten kod Twoją mobilną aplikacją Google Authenticator. Przekopiuj z niej kod identyfikacyjny.',
    ...
    'admin_2factors_authentication_setting_tip' => '<span style=\'font-size:11px;max-width:300px;\'>Uwierzytelnianie Google 2-Factors umożliwia dodanie kolejnego zabezpieczenia do logowania się użytkownika. W momencie logowania do TeamPass generowany jest jednorazowy kod QR. Kod QR musi zostać zeskanowany, aby otrzymać hasło.<br />UWAGA: Wymaga to skanera kodów QR (np. smartphon-a) oraz dostępu do iternetu</span> ',
    '2factors_tile' => '2-poziomowa autoryzacja',
    ...
    'email_body_item_updated' => 'Witaj,<br><br>Hasło dla \'#item_label#\' zostało uaktualnione.<br /><br />Możesz je sprawdzić <a href=\'".@$_SESSION[\'settings\'][\'cpassman_url\']."/index.php?page=items&group=#item_category#&id=#item_id#\'>TUTAJ</a><br /><br />Pozdrawiam,',
    ...
    'email_body1' => 'Witaj,<br><br>Element \'',
    'email_body2' => 'został dodany. <br /><br />Możesz go obejrzeć klikając <a href=\' ',
    'email_body3' => '>TUTAJ</a><br /><br />Pozdrawiam. ',
